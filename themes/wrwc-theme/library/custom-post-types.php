...
function custom_post_type_gallery() {
	$labels = array(
		'name'                  => _x( 'Gallery', 'Post Type General Name', 'wrwc' ),
		'singular_name'         => _x( 'Gallery', 'Post Type Singular Name', 'wrwc' ),
		'menu_name'             => __( 'Gallery', 'wrwc' ),
		'name_admin_bar'        => __( 'Gallery', 'wrwc' ),
		'archives'              => __( 'Gallery Archives', 'wrwc' ),
		'attributes'            => __( 'Gallery Attributes', 'wrwc' ),
		'parent_item_colon'     => __( 'Parent Gallery:', 'wrwc' ),
		'all_items'             => __( 'All Gallery', 'wrwc' ),
		'add_new_item'          => __( 'Add New Gallery', 'wrwc' ),
		'add_new'               => __( 'Add New', 'wrwc' ),
		'new_item'              => __( 'New Gallery', 'wrwc' ),
		'edit_item'             => __( 'Edit Gallery', 'wrwc' ),
		'update_item'           => __( 'Update Gallery', 'wrwc' ),
		'view_item'             => __( 'View Gallery', 'wrwc' ),
		'view_items'            => __( 'View Gallery', 'wrwc' ),
		'search_items'          => __( 'Search Gallery', 'wrwc' ),
		'not_found'             => __( 'Not found', 'wrwc' ),
		'not_found_in_trash'    => __( 'Not found in Trash', 'wrwc' ),
		'featured_image'        => __( 'Featured Image', 'wrwc' ),
		'set_featured_image'    => __( 'Set featured image', 'wrwc' ),
		'remove_featured_image' => __( 'Remove featured image', 'wrwc' ),
		'use_featured_image'    => __( 'Use as featured image', 'wrwc' ),
		'insert_into_item'      => __( 'Insert into gallery', 'wrwc' ),
		'uploaded_to_this_item' => __( 'Uploaded to this gallery', 'wrwc' ),
		'items_list'            => __( 'Gallery list', 'wrwc' ),
		'items_list_navigation' => __( 'Gallery list navigation', 'wrwc' ),
		'filter_items_list'     => __( 'Filter Gallery list', 'wrwc' ),
	);
	$args   = array(
		'label'               => __( 'Gallery', 'wrwc' ),
		'description'         => __( 'Gallery Description', 'wrwc' ),
		'labels'              => $labels,
